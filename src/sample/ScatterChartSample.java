...
public class ScatterChartSample {
    ...
    public static void start() {
        ...
        final NumberAxis xAxis = new NumberAxis(0, 10, 1); //диапозон
        final NumberAxis yAxis = new NumberAxis(-100, 500, 100);

        final ScatterChart<Number,Number> sc = new // самый главный контейнер, с данными
                ScatterChart<>(xAxis,yAxis);

        xAxis.setLabel("Age (years)"); // подписи
        ...
        sc.getData().addAll(series1, series2); // метки в контейнер
        Scene scene  = new Scene(sc, 500, 400); // сцена
